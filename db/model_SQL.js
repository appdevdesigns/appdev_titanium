...
var log = function() {
    Ti.API.log(Array.prototype.join.call(arguments, ''));
};
...
module.exports = $.Model('AD.Model.ModelSQL', {
    ...
    condFromReq: function(req) {
        ...
        var providedData = $.extend({}, req.body, req.query);
...
//            log(req, returnArray);
    ...
    addLookupLabels: function (req, curDataMgr) {
        ...
        if (typeof this.lookupLabels != 'undefined') {
            var lookupTref = 1;
            var langCode = curDataMgr.model['language_code'] || (req.aRAD && req.aRAD.viewer.languageKey) || AD.Defaults.languageKey;
