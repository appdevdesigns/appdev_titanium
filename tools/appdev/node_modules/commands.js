        ...
        try {
            ...
            if (module.operationStack) {
                ...
                subcmd.act(function(opts, args, res) {
                    ...
                    var operations = operationStack.map(function(operation) {
            ...
            if (options.onCommand) {
                // Call the onCommand callback to facilitate generic processing of all loaded commands
                options.onCommand(subcmd);
            }
            subcmd.end();
        }
        catch(e) {
            if (e.code === 'MODULE_NOT_FOUND') {
                ...
                console.error('Try running "appdev install" to install command dependencies'.hint);
            }
            else {
