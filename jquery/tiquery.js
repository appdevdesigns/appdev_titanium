...
(function(global, Titanium, _undefined) {
var TiQuery = (function() {
	...
	TiQuery.fn = TiQuery.prototype = {
		init: function( selector, context ) {	
            ...
            return TiQuery.makeArray( selector, this );
		},
	...
	TiQuery.extend({
		...
		isPlainObject: function( obj ) {
			...
			return key === _undefined || hasOwnProperty.call( obj, key );
		},
		...
		each: function( object, callback, args ) {
			var name, i = 0,
				...
				isObj = length === _undefined || TiQuery.isFunction(object);
