...
var EncryptionKey = module.exports = {
    ...
    encryptionActivated: function() {
        ...
        // If the device is encrypted with full-device encryption, then the password will be stored in the application properties
        // If the database is encrypted, then the password hash will be stored in the application properties
        return EncryptionKey.encryptionNecessary() && !!(AD.Platform.isiOS || Ti.App.Properties.getString('password') || Ti.App.Properties.getString('passwordHash'));
    },
    get: function() {
